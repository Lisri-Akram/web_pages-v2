package com.example.ChatAi.ChatAi.Service;

import com.example.ChatAi.ChatAi.Model.FieldEntity;
import com.example.ChatAi.ChatAi.Model.FormField;
...
<<<<<<< HEAD:Back_end/src/main/java/com/example/ChatAi/ChatAi/Service/AiService.java
        String systemPrompt = "System: You are a JSON Form Generator.\n"
    + "You will receive a form Title and Description.\n"
    + "Generate a JSON object describing the form using the exact schema below.\n"
    ...
    + "}\n"
    + "\n"
    + "Now generate the JSON for the following form:\n"
    + "Title: \"{FORM_TITLE}\"\n"
...
>>>>>>> 96b38b9342ebadcbfdf6d9ec9afe94ed3821479b:src/main/java/com/example/ChatAi/ChatAi/AiService.java
